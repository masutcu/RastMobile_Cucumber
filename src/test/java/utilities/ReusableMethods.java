...
public class ReusableMethods {
    ...
    public static String addProductRandomly()  {
        ...
        List <WebElement> addElementTitle = Driver.getDriver().findElements(By.xpath("//h2[@class='ProductItem__Title Heading']/a"));
        List <WebElement> addElementPrice = Driver.getDriver().findElements(By.cssSelector(".ProductItem__PriceList .ProductItem__Price.Price--highlight"));
        List <WebElement> addElement = Driver.getDriver().findElements(By.cssSelector("button[class='ProductForm__AddToCart Button Button--secondary Button--full']"));
        ...
        for (int i = 1; i < sayfadakiUrunSayisi; i++) {
            if(i == number){
                if(! addElement.get(i).isDisplayed()){
                    ReusableMethods.scroll( addElement.get(i));
                }
    ...
    public static void hoverOverToElement(WebElement locate)  {
    ...
    public static void raporuAc(){
        ...
        String raporYolu = System.getProperty("user.dir")+"\\TestOutput\\Report\\cucumberHooks.html";
        ...
        if(isRaporExist==true){
            try {
                ...
                String chromePath = "C:\\Program Files\\Mozilla Firefox\\firefox.exe";
     ...
     */
    public static void showElementWithFrameCss(String locate)  {
...
//        String script = "arguments[0].style.border='3px solid green';";
    ...
    public static void showElementWithFrame(WebElement locate)  {

        //String script = "arguments[0].style.border='3px solid red';";
        //String script = "arguments[0].style.border='3px solid white';";
        //String script = "arguments[0].style.border='3px solid yellow';";
        String script = "arguments[0].style.border='5px solid green';";
        ((JavascriptExecutor) Driver.getDriver()).executeScript(script, locate);

    }


    /**
     * Locate xpath formatında alınmalı ve string olarak verilmelidir.
     * @param locate
     */
    public  static  void showElementWithFrameXPath(String locate)  {
